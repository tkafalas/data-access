...
public class PermissionsPanel extends FlexTable implements IFileModifier {
  ...
  final String contextURL = DatasourceAdminDialogController.getAjaxBaseUrl();
  ...
  public PermissionsPanel( RepositoryFile theFileSummary ) {
    ...
    addButton.addClickHandler( new ClickHandler() {
      ...
      public void onClick( ClickEvent clickEvent ) {
        ...
        pickUserRoleDialog.getElement().getStyle().setProperty( "zIndex", "1350" );
      }
        ...
        if ( inheritsCheckBox.getValue() ) {
          ...
          final IDialogCallback callback = new IDialogCallback() {
            ...
            public void okPressed() {
              ...
              String url = contextURL + "api/repo/files/" + DatasourceAdminDialogController.pathToId( path ) + "/acl"; //$NON-NLS-1$ //$NON-NLS-2$
