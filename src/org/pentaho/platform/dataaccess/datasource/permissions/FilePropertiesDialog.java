...
import org.pentaho.platform.dataaccess.datasource.permissions.dialogs.WaitPopup;
import org.pentaho.platform.dataaccess.datasource.permissions.events.EventBusUtil;
import org.pentaho.platform.dataaccess.datasource.permissions.events.GenericEvent;
import org.pentaho.platform.dataaccess.datasource.permissions.messages.Messages;
//tk import org.pentaho.mantle.client.solutionbrowser.SolutionBrowserPanel;
//tk import org.pentaho.mantle.client.ui.PerspectiveManager;
...
public class FilePropertiesDialog extends PromptDialogBox {
  ...
  String contextURL = DatasourceAdminDialogController.getAjaxBaseUrl();
        ...
        requestCallback = new RequestCallback() {
          ...
          public void onResponseReceived( Request arg0, Response arg1 ) {
            ...
            if ( arg1.getStatusCode() == Response.SC_OK ) {
              ...
              // tk PerspectiveManager.getInstance().setPerspective( PerspectiveManager.BROWSER_PERSPECTIVE );
  ...
  protected void getAcls( RepositoryFile fileSummary ) {
    String url = contextURL + "api/repo/files/" + DatasourceAdminDialogController.pathToId( fileSummary.getPath() ) + "/acl"; //$NON-NLS-1$ //$NON-NLS-2$
  ...
  protected void getMetadata( RepositoryFile fileSummary ) {
    String fileId = DatasourceAdminDialogController.pathToId( fileSummary.getPath() ) ;
    String metadataUrl = contextURL + "api/repo/files/" + fileId + "/metadata?cb=" + System.currentTimeMillis(); //$NON-NLS-1$ //$NON-NLS-2$
